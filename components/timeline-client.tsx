...
// Event type definitions (duplicated for this component's independence)
interface Event {
  kegiatan: string;
  tanggal: string;
  start: string;
...
export const TimelineClient: React.FC<{
  events: Event[];
                  ...
                  {eventPositions.map((event, index) => {
                    ...
                    return (
                      <div
                        ...
                        } absolute flex h-8 cursor-pointer items-center overflow-visible rounded-full border border-white/20 p-2 text-white transition-all duration-300 hover:z-20 hover:shadow-md ${
                ...
                >
                  {selectedEventStatus &&
                    `${selectedEventStatus.full} ${formatTimeLeft(
                      selectedEventStatus.secondsLeft,
                    )}`}
                </Chip>
                <Button
                  size="sm"
